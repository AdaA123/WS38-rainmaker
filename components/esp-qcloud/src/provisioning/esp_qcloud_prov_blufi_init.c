...
esp_err_t esp_blufi_host_init(void)
{
    ...
    if (ret) {
        ESP_LOGE("blufi init","%s init bluedroid failed: %s\n", __func__, esp_err_to_name(ret));
        return ESP_FAIL;
    }
    ...
    ESP_LOGI("blufi init","BD ADDR: "ESP_BD_ADDR_STR"", ESP_BD_ADDR_HEX(esp_bt_dev_get_address()));
...
{
    ESP_LOGI("blufi init", "BLE Host Task Started");
