 ...
 */
typedef enum {
    QCLOUD_EVENT_IOTHUB_INIT = 1,    /**< QCloud core Initialisation Done */
    QCLOUD_EVENT_IOTHUB_DEINIT,      /**< QCloud core Initialisation Done */
    QCLOUD_EVENT_IOTHUB_BLE_GET_TOKEN,      /**< QCloud bind device */
    ...
    QCLOUD_EVENT_IOTHUB_LOCAL_NETWORK, 
    QCLOUD_EVENT_IOTHUB_MQTT_CONNECT,
    QCLOUD_EVENT_IOTHUB_MQTT_DISCONNECT,
    QCLOUD_EVENT_IOTHUB_CLOUD_CONNECT,
    QCLOUD_EVENT_IOTHUB_CLOUD_DISCONNECT,
...
esp_err_t esp_qcloud_iothub_deinit(void);

esp_err_t esp_qcloud_iothub_things_init(void);

esp_err_t esp_qcloud_iothub_things_deinit(void);
